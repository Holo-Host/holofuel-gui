...
const NotRegistered = () => (
  <div className="error-container text-center" style={{margin:"20vh"}}>
    <div className="error" style={{justifyContent:'center', color:"#0e094b", padding: 20, width: '50%', margin: '0 auto', background:'#fcfeff', border: '2px solid #bec4dd', minWidth:'150px'}}>
